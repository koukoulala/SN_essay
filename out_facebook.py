...
savetxt("tmp/facebook/train_facebook.csv",trainX,fmt="%d",delimiter=",")
savetxt("tmp/facebook/train_facebook1.csv", train1, fmt="%d", delimiter=",")
savetxt("tmp/facebook/train_facebook2.csv", train2, fmt="%d", delimiter=",")
savetxt("tmp/facebook/train_facebook3.csv", train3, fmt="%d", delimiter=",")
savetxt("tmp/facebook/test_facebook.csv",testX,fmt="%d",delimiter=",")
savetxt("tmp/facebook/test_facebook1.csv", test1, fmt="%d", delimiter=",")
savetxt("tmp/facebook/test_facebook2.csv", test2, fmt="%d", delimiter=",")
savetxt("tmp/facebook/test_facebook3.csv", test3, fmt="%d", delimiter=",")
