...
savetxt("tmp/bcspwr/train.csv",trainX,fmt="%d",delimiter=",")
savetxt("tmp/bcspwr/train1.csv", train1, fmt="%d", delimiter=",")
savetxt("tmp/bcspwr/train2.csv", train2, fmt="%d", delimiter=",")
savetxt("tmp/bcspwr/train3.csv", train3, fmt="%d", delimiter=",")
savetxt("tmp/bcspwr/test.csv",testX,fmt="%d",delimiter=",")
savetxt("tmp/bcspwr/test1.csv", test1, fmt="%d", delimiter=",")
savetxt("tmp/bcspwr/test2.csv", test2, fmt="%d", delimiter=",")
savetxt("tmp/bcspwr/test3.csv", test3, fmt="%d", delimiter=",")
