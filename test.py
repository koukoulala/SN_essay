...
Lfile='data/facebook_4039/facebook_4039.txt';
Cfile='data/facebook_4039/facebook_4039_communities.txt'
#Lfile = 'data/biological_tim/biological_tim.txt'
#Cfile='data/biological_tim/biological_tim_communities.txt'
...
savetxt("tmp/train_facebook.csv",trainX,fmt="%d",delimiter=",")
savetxt("tmp/train_facebook1.csv", train1, fmt="%d", delimiter=",")
savetxt("tmp/train_facebook2.csv", train2, fmt="%d", delimiter=",")
savetxt("tmp/train_facebook3.csv", train3, fmt="%d", delimiter=",")
savetxt("tmp/test_facebook.csv",testX,fmt="%d",delimiter=",")
savetxt("tmp/test_facebook1.csv", test1, fmt="%d", delimiter=",")
savetxt("tmp/test_facebook2.csv", test2, fmt="%d", delimiter=",")
savetxt("tmp/test_facebook3.csv", test3, fmt="%d", delimiter=",")
